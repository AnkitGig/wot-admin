...
export default function AddLessonToChapter() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.content_type === 'text') {
      ...
      const hasMedia = formData.media instanceof File;
    ...
    const result = await createLesson(chapterId, payload, token);
        ...
        <div className="content container-fluid">
          <div className="page-header">
            <div className="row align-items-center">
              <div className="col">
                <h3 className="page-title">Add Lesson to Chapter</h3>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="row mt-5 mb-5">
              <div className="col-12 text-center">
                <hr className="mb-4" />
                <button type="button" className="btn btn-lg btn-outline-secondary px-5 me-3" onClick={() => navigate(-1)} disabled={isLoading}>Cancel</button>
                <button type="submit" className="btn btn-lg btn-primary px-5 shadow" disabled={isLoading}>
                  {isLoading ? <><i className="fas fa-spinner fa-spin me-2"></i>Adding...</> : <><i className="fas fa-plus me-2"></i>Create Lesson</>}
                </button>
              </div>
            </div>
          </form>
